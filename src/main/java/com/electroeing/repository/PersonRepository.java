...
public class PersonRepository {
    ...
    public static List<Person> getAllPersons() {
        ...
        Person p6 = new Person("Alan", 110, 9500, Gender.MALE.getGenderName(), 2, Arrays.asList("Cricket", "Swimming", "Tennis"));
    ...
    public static Person getPerson() {
        return new Person("John", 165, 2000, Gender.MALE.getGenderName(), 2, Arrays.asList("Cricket", "Swimming", "Tennis"));
    }
